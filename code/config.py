...
parser = argparse.ArgumentParser(description="Pytorch implementation of methods for ECM")

# Data
parser.add_argument('--sample_file_no', default=3, type=int, help='sample file number')
parser.add_argument('--seed_no', default=50, type=int, help='seed number')
parser.add_argument('--user_no', default=3000, type=int, help='number of users')
